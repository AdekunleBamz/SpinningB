...
## Purpose
Define a repeatable process for Non Functional Tests in the SpinningB repository.
...
## Procedure
1. Review contract expectations in contracts/spinning-board.clar related to Non Functional Tests.
...
- [ ] Contract behavior for Non Functional Tests is documented and verified.
